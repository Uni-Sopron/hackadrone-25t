...
A virtuális világot egy szerver szimulálja, amit a megadott [API](https://docker.gazd.info/hackathon/openapi)-n keresztül lehet elérni információk lekérdezéséhez és utasítások kiadásához.
